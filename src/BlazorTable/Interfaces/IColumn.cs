...
namespace BlazorTable {
	...
	/// <summary>
	/// Defines the options for a given column.
	/// </summary>
	/// <typeparam name="TableItem">The type of data the column is related to.</typeparam>
	public interface IColumnOptions<TableItem> {
		...
		/// Required when Sortable = true or <br />
	...
	public interface IColumn<TableItem> : IColumnOptions<TableItem> {
